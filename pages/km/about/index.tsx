...
const title = "អំពី Mugnee Cambodia | LED Display និងដំណោះស្រាយបច្ចេកវិទ្យា";
const description =
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${SITE_URL}/km/about/`} />
        ...
        <meta
          property="og:title"
          content="អំពី Mugnee Cambodia | អ្នកផ្គត់ផ្គង់ LED Display និងដំណោះស្រាយបច្ចេកវិទ្យា"
        />
        <meta
          property="og:description"
          content="ស្គាល់ក្រុមហ៊ុន Mugnee Cambodia, បទពិសោធន៍គម្រោង និងសេវាបច្ចេកទេសសម្រាប់ LED Display និងដំណោះស្រាយអាជីវកម្មនៅកម្ពុជា។"
        />
        <meta property="og:url" content={`${SITE_URL}/km/about/`} />
        ...
        <meta
          ...
          content="បទពិសោធន៍គម្រោង និងសេវាបច្ចេកទេសរបស់ Mugnee Cambodia នៅកម្ពុជា។"
        />
