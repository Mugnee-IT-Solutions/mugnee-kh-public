...
const title = "Interactive Flat Panel Cambodia | Smart Board";
const description =
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="4K interactive flat panels and smart boards for schools and offices in Cambodia with consultation, delivery, and installation."
        />
        <meta property="og:url" content={`${SITE_URL}/interactive-flat-panel/`} />
