...
export const INDUSTRY_SOLUTIONS: IndustrySolution[] = [
  {
    ...
    internalLinks: [
      ...
      { label: "Digital Signage Products", href: "/products/catalog/digital-signage" },
  ...
  },
  {
    ...
    internalLinks: [
      ...
      { label: "PA System Product Catalog", href: "/products/catalog/pa-system" },
  ...
  },
  {
    ...
    internalLinks: [
      ...
      { label: "Access Control Products", href: "/products/catalog/access-control" },
      { label: "Turnstile Product Catalog", href: "/products/catalog/turnstile-gate" },
  ...
  },
  {
    ...
    internalLinks: [
      { label: "Interactive Flat Panel", href: "/interactive-flat-panel" },
      { label: "Interactive Panel Products", href: "/products/catalog/interactive-panel" },
      { label: "Smart Board Product Range", href: "/products/catalog/smart-board" },
