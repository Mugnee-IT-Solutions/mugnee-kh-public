...
export const INDUSTRY_SOLUTIONS: IndustrySolution[] = [
  {
    ...
    internalLinks: [
      ...
      { label: "Digital Signage Products", href: "/products/digital-signage" },
  ...
  },
  {
    ...
    internalLinks: [
      ...
      { label: "PA System Product Catalog", href: "/products/pa-system" },
  ...
  },
  {
    ...
    internalLinks: [
      ...
      { label: "Access Control Products", href: "/products/access-control" },
      { label: "Turnstile Product Catalog", href: "/products/turnstile-gate" },
  ...
  },
  {
    ...
    internalLinks: [
      { label: "Interactive Flat Panel", href: "/interactive-flat-panel" },
      { label: "Interactive Panel Products", href: "/products/interactive-panel" },
      { label: "Smart Board Product Range", href: "/products/smart-board" },
