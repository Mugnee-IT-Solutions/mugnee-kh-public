...
export default function PaSystemClient() {
  ...
  const t = useMemo(() => {
    ...
    const km = {
      ...
      c1: "ឧបករណ៍លាយសំឡេង និងអំព្លីហ្វាយអ័រ",
    ...
    () => [
      {
        ...
        qKm: "ប្រព័ន្ធ PA គឺអ្វី ហើយប្រើនៅកម្ពុជាក្នុងកន្លែងណាខ្លះ?",
        aKm:
      ...
      },
      {
        ...
        qKm: "តើខ្ញុំជ្រើសឧបករណ៍បំពងសំឡេងសម្រាប់រោងចក្រ សាលារៀន ឬហាងលក់រាយយ៉ាងដូចម្តេច?",
        aKm:
      ...
      },
      {
        ...
        qKm: "ប្រព័ន្ធ PA គួរមានប៉ុន្មានតំបន់?",
        aKm:
      ...
      },
      {
        ...
        qKm: "សម្រាប់ការប្រកាសឲ្យច្បាស់ តើត្រូវការកម្លាំងអំព្លីហ្វាយអ័រប៉ុន្មាន?",
        aKm:
      ...
      },
      {
        ...
        qKm: "ប្រព័ន្ធ PA អាចរួមបញ្ចូលជាមួយប្រព័ន្ធជូនដំណឹងអគ្គិភ័យ ឬសុវត្ថិភាពបានទេ?",
        aKm:
      ...
      },
      {
        ...
        qKm: "តើអ្នកដំឡើងប្រព័ន្ធ PA ទាំងក្នុងអគារ និងក្រៅអគារដែរឬទេ?",
        aKm:
      ...
      },
      {
        ...
        qKm: "ការដំឡើងប្រព័ន្ធ PA នៅកម្ពុជា ចំណាយពេលប៉ុន្មាន?",
        aKm:
      ...
      },
      {
        ...
        qKm: "តើអ្នកផ្តល់ការធានា និងសេវាគាំទ្របន្ទាប់ពីលក់ដែរឬទេ?",
        aKm:
