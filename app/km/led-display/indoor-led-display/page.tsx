...
export default function IndoorLedDisplayPage() {
  ...
  const indoorItemListJsonLd = {
    ...
    "@type": "ItemList",
    name: "ផលិតផលអេក្រង់ LED ក្នុងអគារនៅកម្ពុជា",
  ...
  const indoorClusterKm = [
    ...
    { title: "ស្នើសុំតម្លៃអេក្រង់ LED ក្នុងអគារ", href: "/km/contact" },
  ];
  ...
  return (
    <>
      ...
      <LedDisplayClient
        ...
        schemaPathOverride="/km/led-display/indoor-led-display"
        schemaNameOverride="អេក្រង់ LED ក្នុងអគារ"
        schemaServiceNameOverride="អេក្រង់ LED ក្នុងអគារនៅកម្ពុជា"
