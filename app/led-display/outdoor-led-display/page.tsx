...
export default function OutdoorLedDisplayPage() {
  ...
  const outdoorClusterKm = [
    { title: "?????????????? LED", href: "/led-display" },
    { title: "??????? LED ??????????????????", href: "/led-display/indoor-led-display" },
    { title: "????????????? LED ???????", href: "/products/catalog/outdoor-led-display" },
    { title: "???????????? Video Processor ??????? LED", href: "/led-display/video-processor" },
    { title: "????????? ??????????????????", href: "/service" },
    { title: "???????????????????????????", href: "/solutions" },
    { title: "?????????", href: "/projects" },
    { title: "??????????????????? LED ???????", href: "/contact" },
  ];
  ...
  const outdoorTrustSignalsKm = [
    "?????????? Structured FAQ ???????? Entity ??????? Outdoor LED ????????",
    "??????????????????? IP protection ??????????? ?????????????????????????",
    "????????????????????????????????? ?????????????????????????????????????????",
    "????????????????????????????????? Facade ?????????????????",
  ];
  ...
  return (
    <>
      ...
      <LedDisplayClient
        ...
        trustDescOverrideKm="????? Outdoor LED ????????????????????????????????????????????? ??? Facade ?????? FAQ ??????????????? ???????????????????????? ??? internal linking ??-??????????????"
        internalLinkTitleOverride="Outdoor LED Internal Linking Cluster"
        internalLinkTitleOverrideKm="????????????????????????????? LED ???????"
        ...
        heroIntroOverrideKm="Mugnee ?????????????????????? LED ???????????????? ????????????????????????? ??????? Facade ?????????????? DOOH ????????? Digital Signage ???????? ????????????????????????????? LED ??????????????????????? ?????????????????????????????????? IP65-ready ???????? Pixel Pitch ????????????????????????????? ??????????????????????????????????????????????????????????????? ???????????? P2.5 ??? P10 ??????????????????????????????? ???????????? controller ???????????????? ???????? ??????????????????????? ????????????????????????????? ????? BOQ ????????????????????????????"
        afterSpecsContent={
        ...
        pixelPitchIntroOverrideKm="??????? LED ???????????????????????????? ??????????????? ??????????????? IP? ???????????????????????????????????????????????"
