...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    descriptionKm: "DS7300 Speed Gate Turnstile with stainless steel body, Plexiglas arm, single/bi-directional access, 4555 persons/min flow, and IR sensors.",
    ...
    seoDescKm: "DS7300 Speed Gate Turnstile with stainless steel body, Plexiglas arm, single/bi-directional access, 4555 persons/min flow, and IR sensors.",
  },
  {
  ...
  },
  {
    ...
    descriptionKm: "The DS7100 Automatic Speed Gate Turnstile features a 304 stainless steel body, a Plexiglas arm, a single/bi-directional mode, a 6001200 mm passage, and a 4555 person/min speed.",
    featuresEn: ["Speed gate design", "RFID/QR/biometric integration", "Durable stainless-steel body"],
    featuresKm: ["Speed gate design", "RFID/QR/biometric integration", "Durable stainless-steel body"],
    applicationsEn: ["Office", "Factory", "Public venue"],
    applicationsKm: ["Office", "Factory", "Public venue"],
    ...
    seoDescKm: "The DS7100 Automatic Speed Gate Turnstile features a 304 stainless steel body, a Plexiglas arm, a single/bi-directional mode, a 6001200 mm passage, and a 4555 person/min speed.",
  },
  {
    ...
    descriptionKm: "Key Features 304 stainless steel construction with modern design Programmable operation modes for various access needs Anti-collision safety with gentle gate retraction Automatic reset after timeout (160 seconds) Integration with access control, ticketing, and ESD systems Advanced infrared sensor array for safety and security LED direction indicators for clear entry/exit guidance Bi-directional operation with remote control support Handles 3045 persons per minute",
    featuresEn: ["Speed gate design", "RFID/QR/biometric integration", "Durable stainless-steel body"],
    featuresKm: ["Speed gate design", "RFID/QR/biometric integration", "Durable stainless-steel body"],
    applicationsEn: ["Office", "Factory", "Public venue"],
    applicationsKm: ["Office", "Factory", "Public venue"],
    ...
    seoDescKm: "Key Features 304 stainless steel construction with modern design Programmable operation modes for various access needs Anti-collision safety with gentle gate retraction Automatic reset after timeout (160 seconds) Integration with access control, ticketing, and ESD systems Advanced infrared sensor array for safety and security LED direction indicators for clear entry/exit guidance Bi-directional operation with remote control support Handles 3045 persons per minute",
  },
  {
    ...
    descriptionKm: "Key features Configurable operation modes: auto, one-way, or two-way Dual synchronized wings for smooth, coordinated movement Anti-collision safety with gentle gate retraction Automatic reset if passage is not completed within set time Integration with access control, ticketing, and biometric systems Three pairs of infrared sensors for safety and security LED direction indicators for user guidance Durable 304 stainless steel construction Handles 3045 persons per minute",
    featuresEn: ["Flap barrier design", "RFID/QR/biometric integration", "Durable stainless-steel body"],
    featuresKm: ["Flap barrier design", "RFID/QR/biometric integration", "Durable stainless-steel body"],
    applicationsEn: ["Office", "Factory", "Public venue"],
    applicationsKm: ["Office", "Factory", "Public venue"],
    ...
    seoDescKm: "Key features Configurable operation modes: auto, one-way, or two-way Dual synchronized wings for smooth, coordinated movement Anti-collision safety with gentle gate retraction Automatic reset if passage is not completed within set time Integration with access control, ticketing, and biometric systems Three pairs of infrared sensors for safety and security LED direction indicators for user guidance Durable 304 stainless steel construction Handles 3045 persons per minute",
  },
  {
    ...
    descriptionKm: "Key Features Integrated LED counters for real-time entry/exit tracking 304 stainless steel cabinet with acrylic sliding panels Silent brushless DC motor for smooth, durable operation Supports RFID, QR code, barcode, and biometric authentication Multiple infrared sensors prevent tailgating and collisions Auto-reset mechanism for enhanced security Adjustable passage width: 550900 mm Fast opening speed: 0.51.0 seconds Service life of up to 5 million operations",
    ...
    seoDescKm: "Key Features Integrated LED counters for real-time entry/exit tracking 304 stainless steel cabinet with acrylic sliding panels Silent brushless DC motor for smooth, durable operation Supports RFID, QR code, barcode, and biometric authentication Multiple infrared sensors prevent tailgating and collisions Auto-reset mechanism for enhanced security Adjustable passage width: 550900 mm Fast opening speed: 0.51.0 seconds Service life of up to 5 million operations",
  },
  {
