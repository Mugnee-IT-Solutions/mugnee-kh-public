...
<p align="center">
  <img src="./screenshots/01-homepage-hero.png" alt="Mugnee Cambodia — homepage hero with smart classroom and primary value proposition" width="920" />
</p>

<p align="center"><sub><strong>First impression that holds.</strong> Clear positioning, confident storytelling, and obvious next steps—quotation, exploration, and human contact.</sub></p>
...
<p align="center">
  <img src="./screenshots/06-header-footer-trust.png" alt="Site header with search and navigation, and footer with service areas, categories, and quotation call-to-action" width="920" />
</p>

<p align="center"><sub><strong>Continuity builds trust.</strong> Navigation, search, language choice, and footer systems work together so the brand feels deliberate end-to-end.</sub></p>
...
<p align="center">
  <img src="./screenshots/05-contact-lead-capture.png" alt="Contact page with inquiry form and contact channels" width="920" />
</p>

<p align="center"><sub><strong>Conversion, thoughtfully designed.</strong> A contact experience that matches the quality of the rest of the site—and supports real follow-up.</sub></p>
...
<details>
<summary><strong>For non-technical stakeholders: what this means in practice</strong></summary>
...
<p align="center">
  <img src="./screenshots/02-interactive-flat-panel-hub.png" alt="Interactive Flat Panel hub with filters, sorting, and quotation calls to action" width="920" />
</p>

<p align="center"><sub>Example hub layout: filters, sorting, and obvious paths to models and quotation.</sub></p>

### Product detail — confidence in the specifics

<p align="center">
  <img src="./screenshots/03-product-detail-led.png" alt="Indoor LED product detail page with gallery, tags, and quotation button" width="920" />
</p>

<p align="center"><sub>Product storytelling with gallery context and a clean path to commercial next steps.</sub></p>

### Resources — authority that supports the sale

<p align="center">
  <img src="./screenshots/04-featured-posts-resources.png" alt="Featured posts section with article cards for LED and display topics" width="920" />
</p>

<p align="center"><sub>Editorial modules that help buyers research deeply—then reach out with better questions.</sub></p>
...
<sub>Portfolio repository: <code>mugnee-kh-public</code></sub>
